...
function Hot() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().request({
      method: 'GET',
      url: "".concat(requestUrl, "/v1/posts/getHotList"),
      success: function success(res) {
        console.log(res);
        var hotTags = res.data.data.posts.map(function (post) {
          return {
            post_id: post._id,
            title: post.title,
...
/* harmony import */ var _static_post_post_like_icon_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../static/post/post-like-icon.png */ "./src/static/post/post-like-icon.png");
...
function TagContent() {
  ...
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false),
    _useState14 = (0,E_dev_CQNU_Mini_Program_frontend_node_modules_babel_runtime_helpers_esm_slicedToArray_js__WEBPACK_IMPORTED_MODULE_9__["default"])(_useState13, 2),
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    var updateLikeNum = pubsub_js__WEBPACK_IMPORTED_MODULE_2___default().subscribe('updatePostData', /*#__PURE__*/function () {
      var _ref3 = (0,E_dev_CQNU_Mini_Program_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_10__["default"])( /*#__PURE__*/(0,E_dev_CQNU_Mini_Program_frontend_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_11__["default"])().mark(function _callee3(msg, data) {
        var newposts;
        return (0,E_dev_CQNU_Mini_Program_frontend_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_11__["default"])().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              newposts = posts.map(function (post) {
                if (post._id === data.post_id) {
                  return (0,E_dev_CQNU_Mini_Program_frontend_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_12__["default"])((0,E_dev_CQNU_Mini_Program_frontend_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_12__["default"])({}, post), {}, {
