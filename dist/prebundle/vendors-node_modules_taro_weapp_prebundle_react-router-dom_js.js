"use strict";
(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["vendors-node_modules_taro_weapp_prebundle_react-router-dom_js"],{

/***/ "./node_modules/.taro/weapp/prebundle/react-router-dom.js":
/*!****************************************************************!*\
  !*** ./node_modules/.taro/weapp/prebundle/react-router-dom.js ***!
  \****************************************************************/
...
/* harmony export */   "NavigationType": function() { return /* binding */ Action; },
...
/* provided dependency */ var URL = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-3ISTQUJZ.js */ "./node_modules/.taro/weapp/prebundle/chunk-3ISTQUJZ.js")["URL"];
...
/* provided dependency */ var URLSearchParams = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-3ISTQUJZ.js */ "./node_modules/.taro/weapp/prebundle/chunk-3ISTQUJZ.js")["URLSearchParams"];
...
var React2 = (0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_1__.__toESM)((0,_chunk_LNJCN3VW_js__WEBPACK_IMPORTED_MODULE_0__.require_react_production_min)());
// node_modules/react-router/dist/index.js
var React = (0,_chunk_P7VEE7PG_js__WEBPACK_IMPORTED_MODULE_1__.__toESM)((0,_chunk_LNJCN3VW_js__WEBPACK_IMPORTED_MODULE_0__.require_react_production_min)());
...
function createRouter(init) {
    ...
    function _startNavigation() {
        _startNavigation = _asyncToGenerator(function*(historyAction, location, opts) {
            ...
            let { shortCircuited , loaderData , errors  } = yield handleLoaders(request, location, matches, loadingNavigation, opts && opts.submission, opts && opts.fetcherSubmission, opts && opts.replace, pendingActionData, pendingError);
            if (shortCircuited) {
                return;
            }
            pendingNavigationController = null;
    ...
    function _handleAction() {
        _handleAction = _asyncToGenerator(function*(request, location, submission, matches, opts) {
            ...
            if (!actionMatch.route.action && !actionMatch.route.lazy) {
                ...
                result = yield callLoaderOrAction("action", request, actionMatch, matches, manifest, mapRouteProperties2, basename);
    ...
    function _handleLoaders() {
        _handleLoaders = _asyncToGenerator(function*(request, location, matches, overrideNavigation, submission, fetcherSubmission, replace, pendingActionData, pendingError) {
            ...
            if (redirect3) {
                ...
                yield startRedirectNavigation(state, redirect3.result, {
                    replace
                });
                return {
                    shortCircuited: true
    ...
    function _handleFetcherAction() {
        _handleFetcherAction = _asyncToGenerator(function*(key, routeId, path, match, requestMatches, submission) {
            ...
            let actionResult = yield callLoaderOrAction("action", fetchRequest, match, requestMatches, manifest, mapRouteProperties2, basename);
            ...
            if (state.fetchers.has(key)) {
                let doneFetcher1 = getDoneFetcher(actionResult.data);
    ...
    function _handleFetcherLoader() {
        _handleFetcherLoader = _asyncToGenerator(function*(key, routeId, path, match, matches, submission) {
            ...
            fetchControllers.set(key, abortController);
            let originatingLoadId = incrementingLoadId;
            let result = yield callLoaderOrAction("loader", fetchRequest, match, matches, manifest, mapRouteProperties2, basename);
            if (isDeferredResult(result)) {
    ...
    function startRedirectNavigation(state2, redirect3, _temp) {
        return _startRedirectNavigation.apply(this, arguments);
    }
    function _startRedirectNavigation() {
        _startRedirectNavigation = _asyncToGenerator(function*(state2, redirect3, _temp) {
    ...
    function _callLoadersAndMaybeResolveData() {
        _callLoadersAndMaybeResolveData = _asyncToGenerator(function*(currentMatches, matches, matchesToLoad, fetchersToLoad, request) {
            let results = yield Promise.all([
                ...matchesToLoad.map((match)=>callLoaderOrAction("loader", request, match, matches, manifest, mapRouteProperties2, basename)),
...
function _loadLazyRouteModule() {
    _loadLazyRouteModule = _asyncToGenerator(function*(route, mapRouteProperties2, manifest) {
        if (!route.lazy) {
            return;
        }
...
function callLoaderOrAction(type, request, match, matches, manifest, mapRouteProperties2, basename, opts) {
    return _callLoaderOrAction.apply(this, arguments);
}
function _callLoaderOrAction() {
    _callLoaderOrAction = _asyncToGenerator(function*(type, request, match, matches, manifest, mapRouteProperties2, basename, opts) {
        if (opts === void 0) {
            opts = {};
        }
        let resultType;
        ...
        try {
            ...
            if (match.route.lazy) {
                if (handler) {
                    ...
                    yield loadLazyRouteModule(match.route, mapRouteProperties2, manifest);
                ...
                let pathname1 = url1.pathname + url1.search;
...
function useMatch(pattern) {
    ...
    return React.useMemo(()=>matchPath(pattern, pathname), [
        pathname,
        pattern
    ]);
}
...
function useActionData() {
    ...
    let route = React.useContext(RouteContext);
    !route ?  true ? invariant(false, "useActionData must be used inside a RouteContext") : 0 : void 0;
...
function Navigate(_ref4) {
    ...
    !useInRouterContext() ?  true ? invariant(false, "<Navigate> may be used only in the context of a <Router> component.") : 0 : void 0;
     true ? warning(!React.useContext(NavigationContext).static, "<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.") : 0;
    let { matches  } = React.useContext(RouteContext);
    let { pathname: locationPathname  } = useLocation();
...
function getFormSubmissionInfo(target, basename) {
    ...
    if (isFormElement(target)) {
        ...
        let attr1 = target.getAttribute("formaction") || form.getAttribute("action");
    ...
    for (let [key, val] of entries){
        if (val && val.__type === "RouteErrorResponse") {
            ...
            if (serialized[key] == null) {
                let error1 = new Error(val.message);
                error1.stack = "";
...
function useDataRouterContext2(hookName) {
    ...
    !ctx ?  true ? invariant(false, getDataRouterConsoleError2(hookName)) : 0 : void 0;
    return ctx;
}
function useDataRouterState2(hookName) {
    let state = React2.useContext(DataRouterStateContext);
    !state ?  true ? invariant(false, getDataRouterConsoleError2(hookName)) : 0 : void 0;
    return state;
}
...
function useSearchParams(defaultInit) {
    ...
    let location = useLocation();
    let searchParams = React2.useMemo(()=>getSearchParamsForLocation(location.search, hasSetSearchParamsRef.current ? null : defaultSearchParamsRef.current), [
        location.search
    ]);
    let navigate = useNavigate();
...
function useSubmitFetcher(fetcherKey, fetcherRouteId) {
    ...
    return React2.useCallback(function(target, options) {
        ...
        validateClientSideSubmission();
        let { action , method , encType , formData , body  } = getFormSubmissionInfo(target, basename);
        !(fetcherRouteId != null) ?  true ? invariant(false, "No routeId available for useFetcher()") : 0 : void 0;
...
function useFetcher() {
    ...
    let [Form2] = React2.useState(()=>{
        !routeId ?  true ? invariant(false, "No routeId available for fetcher.Form()") : 0 : void 0;
        return createFetcherForm(fetcherKey, routeId);
    });
    let [load] = React2.useState(()=>(href)=>{
            !router ?  true ? invariant(false, "No router available for fetcher.load()") : 0 : void 0;
