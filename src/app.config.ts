export default defineAppConfig({
  pages: [
    ...
    'pages/service/catBook/createCat/createCat',
    'pages/service/catBook/catPage/catPage',
  ...
  tabBar: {
    ...
    borderStyle: "white",
    list: [
      {pagePath: 'pages/index/index', text: '今天', iconPath: './static/tabBar/home-icon.png', selectedIconPath: './static/tabBar/home-selectedIcon.png'},
